...
var _routes = require('../vue/routes.vue');
...
var vm = new _vue2.default({
	...
	components: { 'Routes': _routes2.default },
	ready: function ready() {
		console.log('Routes vm ready.');
	}
});

},{"../vue/routes.vue":6,"vue":4,"vue-resource":3}],6:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		retrieveRoutes: function retrieveRoutes() {
			var _this = this;

			this.$http.get('/api/routes/fetch').then(function (response) {
